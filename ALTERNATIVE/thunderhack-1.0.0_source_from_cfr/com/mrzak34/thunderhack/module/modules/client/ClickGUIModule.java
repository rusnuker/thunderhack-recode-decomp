...
extends Module {
    ...
    public static NumberSetting categoryGreen = new NumberSetting("categoryGreen", 155.0f, 0.0f, 255.0f, false);
    public static NumberSetting categoryBlue = new NumberSetting("categoryBlue", 0.0f, 0.0f, 255.0f, false);
    ...
    public static NumberSetting backgroundGreen = new NumberSetting("backgroundGreen", 0.0f, 0.0f, 255.0f, false);
    public static NumberSetting backgroundBlue = new NumberSetting("backgroundBlue", 0.0f, 0.0f, 255.0f, false);
    public static NumberSetting backgroundAlpha = new NumberSetting("backgroundAlpha", 255.0f, 0.0f, 255.0f, false);
    ...
    public static NumberSetting enabledGreen = new NumberSetting("enabledGreen", 155.0f, 0.0f, 255.0f, false);
    public static NumberSetting enabledBlue = new NumberSetting("enabledBlue", 0.0f, 0.0f, 255.0f, false);
    ...
    public static NumberSetting animationspeed = new NumberSetting("animation speed", 5.0f, 1.0f, 10.0f, false);
    public ThunderGui thunderGui = new ThunderGui();
    private static ClickGUIModule INSTANCE = new ClickGUIModule();

    public ClickGUIModule() {
        super("ClickGUINew", 344, false, Category.CLIENT);
        this.addSettings(icicle, image, category, module, background, enabledColor, gradient, scrollspeed, animationspeed);
        this.setInstance();
    }
    ...
    public void onEnable() {
        super.onEnable();
        if (!(ClickGUIModule.mc.field_1755 instanceof class_442)) {
            mc.method_1507((class_437)this.thunderGui);
        } else {
            Main.currentScreen = this.thunderGui;
        }
