...
{
    BooleanSetting send;
    BooleanSetting receive;
    
    public PacketLogger() {
        super("PacketLogger", 0, false, Category.MISC);
        this.send = new BooleanSetting("send", false);
        this.receive = new BooleanSetting("receive", false);
        this.addSettings(new Setting[] { this.send, this.receive });
    }
    ...
    public void PacketSend(final PacketEvent.Send event) {
        ...
        // Original Bytecode:
        // 
        //     1: getfield        com/mrzak34/thunderhack/module/modules/misc/PacketLogger.send:Lcom/mrzak34/thunderhack/settings/BooleanSetting;
        //     4: invokevirtual   com/mrzak34/thunderhack/settings/BooleanSetting.isEnabled:()Z
        //     7: ifeq            23
        //    10: aload_1         /* event */
        //    11: invokevirtual   com/mrzak34/thunderhack/event/events/PacketEvent$Send.getPacket:()Lnet/minecraft/class_2596;
        //    14: invokevirtual   java/lang/Object.getClass:()Ljava/lang/Class;
        //    17: invokevirtual   java/lang/Class.getName:()Ljava/lang/String;
    ...
    public void PacketReceive(final PacketEvent.Receive event) {
        ...
        // Original Bytecode:
        // 
        //     1: getfield        com/mrzak34/thunderhack/module/modules/misc/PacketLogger.receive:Lcom/mrzak34/thunderhack/settings/BooleanSetting;
        //     4: invokevirtual   com/mrzak34/thunderhack/settings/BooleanSetting.isEnabled:()Z
        //     7: ifeq            23
        //    10: aload_1         /* event */
